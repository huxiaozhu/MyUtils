...
import com.example.administrator.wenlu.fragment.BaseFragment;

import java.util.List;


/**
 * Created by chenhui on 2016/9/7.
 * 显示Fragment的工具类
 */
public class ShowFragmentUtils {
    ...
    public static void popBackStack(FragmentActivity activity,String tag) {
        FragmentManager manager = activity.getSupportFragmentManager();
