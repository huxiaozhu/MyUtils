package com.example.administrator.lock.utils;
...
/**
 * Created by chenhui on 2017/7/7.
 * All Rights Reserved by YiZu
 * 捕获异常的类
 * 参考http://blog.csdn.net/liuhe688/article/details/6584143#
 */
            ...
            cause = cause.getCause();
                ...
                try {
                        ...
                        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                                String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/门锁";
