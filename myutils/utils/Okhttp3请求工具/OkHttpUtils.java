...
public class OkHttpUtils {
     ...
     * @param callback
     */
    public static void postJson(String url, String json, final IOkHttpCallBack callback) {
     ...
     * @param callback
     */
    public static void getData(String url, final IOkHttpCallBack callback) {
